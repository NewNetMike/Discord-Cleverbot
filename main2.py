...
async def on_message(message):
    if message.server.id == "477890034985467904":
        return
    #if not message.author.id == "465203839621136385" and Cleverbot.done is True and message.channel.id == "355493390378336267":
    if not message.author.id == "474478943538380800" and Cleverbot.done is True and message.channel.id == "355493390378336267":
...
print('Starting...')
client.run("NDc0NDc4OTQzNTM4MzgwODAw.Dl5XNA.KqLkR9Yr181kIS6-bsGlmhFPdmg", bot=False)